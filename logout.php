...
<div class="w3-top">
  <div class="w3-bar w3-red w3-card w3-left-align w3-large">
    ...
    <a href="./logout.php" class="w3-bar-item w3-button w3-hide-small w3-padding-large w3-white">log out</a>
  </div>
...
<header class="w3-container w3-red w3-center" style="padding:128px 16px">
  <h1 class="w3-margin w3-jumbo">LOG OUT</h1>
    <form action="logout.php" method="post">
    <button type="submit" class="w3-button w3-black w3-padding-large w3-large w3-margin-top">logout</button>
                </form>
</header>
